...
#### 1. 详细设计并完善实现 Context Inject 功能
- **优先级：** Tier 0（最高）
- **状态：** 待开发
- **背景：** Context Inject 是核心功能，需要从架构层面重新审视和优化
- **待办：**
  - [ ] 梳理现有 Context Inject 实现现状
  - [ ] 设计注入策略（Token 限制、优先级、相关性排序）
  - [ ] 优化注入效率和准确性
  - [ ] 完善边界情况处理
...
- **待办：**
  - [ ] 确定目标用户群体
  - [ ] 制定招募渠道（社区、社交媒体、朋友圈）
  - [ ] 设计反馈收集机制（问卷、访谈、Discord群）
  - [ ] 建立用户反馈闭环流程

#### 3. 上架 Chrome 应用商店
- **优先级：** Tier 0（最高）
- **状态：** 待开发
- **目标：** 让用户可以便捷安装扩展，提升产品可发现性
- **待办：**
  - [ ] 准备商店素材（图标、截图、宣传图）
  - [ ] 编写商店描述和隐私政策
  - [ ] 支付 $5 开发者注册费
...
- **优先级：** Tier 0（最高）
- **状态：** 待开发
- **目标：** 建立产品门面，提升专业度和用户信任
- **待办：**
  - [ ] 设计主页结构（功能介绍、安装指引、FAQ）
  - [ ] 选择部署方案（Vercel/GitHub Pages/Cloudflare Pages）
  - [ ] 绑定域名 omnicontext.app
  - [ ] 添加 Chrome 商店下载链接
  - [ ] 配置 SEO（meta、sitemap、robots.txt）
